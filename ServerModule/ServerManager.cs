...
namespace ServerModule
{
    public static class ServerManager
    {
        ...
        public static void TCPConnect(string _address, int _port)
        {
            ...
            InstanceValue.TCP.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.SendTimeout, 100);
            InstanceValue.TCP.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.ReceiveTimeout, 100);
